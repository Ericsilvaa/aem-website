 ...
 */
package com.adobe.aem.guides.aemprojectdev.core.models;
...
import com.adobe.aem.guides.aemprojectdev.core.testcontext.AppAemContext;
...
class HelloWorldModelTest {
    ...
    public void setup() throws Exception {
        ...
        resource = context.create().resource(page, "hello",
            "sling:resourceType", "aem-project-dev/components/helloworld");
